...
REPO_DIR = Path(r"C:\Users\jvand\Desktop\Dashboard\dashboard_adoropizza")
...
def main():
    print("== Atualizando Adoro Pizza (Matriz) ==")
    ...
    msg = f"Atualização automática ADORO PIZZA - {datetime.now():%Y-%m-%d %H:%M}"
